    ...
    public class GeneradorEnlaces
    {
        ...
        public GeneradorEnlaces(IAuthorizationService authorizationService, IHttpContextAccessor httpContextAccessor,
           IActionContextAccessor actionContextAccessor )
            //Inyectamos IAuthorizationService, IHttpContextAccessor y IActionContextAccessor
        {
        ...
        private async Task<bool> EsAdmin() //Metodo auxiliar
        {
            var httpContext = httpContextAccessor.HttpContext; //Tomamos el HttpContext
            var resultado = await authorizationService.AuthorizeAsync(httpContext.User, "esAdmin");
            //Le pasamos el usuario con HttpContext y el nombre de la politica
            return resultado.Succeeded; //Retornamos que es admin
        }
